...
public class ArtifactoryBuildListener implements BuildListener {
     ...
     * serialize the build-info object into a send-able JSON object to be used by the {@link org.jfrog.build.extractor.clientConfiguration.client.ArtifactoryBuildInfoClient}
     *
